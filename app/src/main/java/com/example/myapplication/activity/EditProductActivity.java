...
public class EditProductActivity extends AppCompatActivity {
    ...
    private void callapiUpdateInforProduct(String titleProduct) {
        ...
        APIService.apiService.updateInforProduct(String.valueOf(Integer.parseInt(titleProduct)), product).enqueue(new Callback<Void>() {
            @Override
    ...
    private void callApiGetInforProduct(String titleProduct) {
        APIService.apiService.getInforProduct(String.valueOf(Integer.parseInt(titleProduct))).enqueue(new Callback<Product>() {
            @Override
